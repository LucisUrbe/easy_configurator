        ...
        child: Column(
          children: <Widget>[
            ...
            TextFormField(
              ...
              maxLines: null,
              initialValue: RouteRulesStore.rules.first.ruleJsonStub,
              cursorColor: gray,
              ...
              decoration: InputDecoration(
                ...
                hintText:
                    AppLocalizations.of(context)!.routeRuleJsonStubHintText,
                hintStyle: const TextStyle(color: gray),
              ),
              onChanged: (inputString) {
                setState(() {
                  RouteRulesStore.rules.first.ruleJsonStub = inputString;
                });
              },
            ),
            const Divider(height: dividerHeight),
